...
## [0.2.0](https://github.com/OxideAV/oxideav-vfw/compare/v0.1.1...v0.2.0) - 2026-07-09

### Other

- vfw r401: README cache-lifecycle + hermetic-discovery sections; fix docs path reference
- vfw r401: end-to-end lifecycle suite through register()/discover + module-doc refresh
- vfw r401: expand leading ~ in OXIDEAV_VFW_CODEC_PATH and OXIDEAV_VFW_CACHE_PATH
- vfw r401: OXIDEAV_VFW_CACHE_PATH — explicit cache-file override
- vfw r401: collapse duplicate-path cache rows on load, keeping the last occurrence
- vfw r401: clean up stranded tempfile when atomic cache save fails
- vfw r401: heal corrupt cache files on zero-probe cycles via Cache::load_or_heal
- vfw r401: prune cache rows for DLLs deleted from walked roots
- vfw r401: dedupe duplicate discovery roots — each distinct root walked once
- vfw r401: deterministic discovery walk order — sort candidates by path per directory
- vfw r401: discover_with_cache — hermetic explicit-cache discovery entry point
